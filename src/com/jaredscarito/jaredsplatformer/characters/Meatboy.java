...
public class Meatboy extends GameCharacter
{
	...
	public Meatboy(int startX, int startY, Graphics g, BufferedImage canvas, int speed, boolean isMoveable,
			Color... cantCollide)
	{
		...
		// System.out.println("irrelevantPoints HashMap Keyset: " +
		// Arrays.toString(this.irrelevantPoints.keySet().toArray()));
	}
